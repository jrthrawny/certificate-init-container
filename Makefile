...
PKG := certificate-init-container

# TESTRUN_DOCKERIMAGE_PREFIX is a value which will be prefixed to all build images
# during test runs.
TESTRUN_DOCKERIMAGE_PREFIX :=

# Docker repo for a push
DOCKER_REPO ?= drud/$(TESTRUN_DOCKERIMAGE_PREFIX)certificate-init-container
